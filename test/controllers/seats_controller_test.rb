...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference("Seat.count") do
      post seats_url, params: { seat: { Course_id: @seat.Course_id, Student_id: @seat.Student_id } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { Course_id: @seat.Course_id, Student_id: @seat.Student_id } }
